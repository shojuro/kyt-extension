...
CREATE TABLE public.waitlist_captures (
...
CREATE INDEX idx_waitlist_source ON public.waitlist_captures (source);
CREATE INDEX idx_waitlist_created ON public.waitlist_captures (created_at);
