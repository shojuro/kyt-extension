-- Add 'notebooklm' to platform CHECK constraints on chat_turns and conversations.
-- Enables storing NotebookLM research findings as content_type: 'research'.
...
ALTER TABLE chat_turns ADD CONSTRAINT chat_turns_platform_check
  CHECK (platform IN ('chatgpt', 'claude', 'cli', 'claude-code', 'gemini', 'notebooklm'));
